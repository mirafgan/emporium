 ...
 *         description: Internal server error
 */
export const editCategoriesById = async (req: Request, res: Response): Promise<void> => {
    try {
        const categoryId = parseInt(req.params.id);
        const { name, slug } = req.body;
 ...
 *         description: Internal server error
 */
export const getSubcategoriesById = async (req: Request, res: Response): Promise<void> => {
    try {
 ...
 *         description: Internal server error
 */
export const editSubcategoriesById = async (req: Request, res: Response): Promise<void> => {
    try {
        const subcategoryId = parseInt(req.params.id);
        const { name, categoryId, slug } = req.body;
 ...
 *         description: Internal server error
 */
export const deleteSubcategoryById = async (req: Request, res: Response): Promise<void> => {
    try {
        const subcategoryId = parseInt(req.params.id);
